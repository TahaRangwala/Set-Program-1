/*Name: Taha Rangwala
 * Date: March 6, 2017
 * Purpose: The purpose of this class is to allow the user to perform
 * tasks using the array set, which allows the user to use a friendly interface
 * to do his or her tasks.
 */
...
//arrayGUI class header
public class arrayGUI extends GBDialog{
	 ...
	 */
	public arrayGUI(JFrame F) {
		super(F);
		setSize(350,350);//size of the GUI interface
		setTitle("Taha's Array Set Program");//title of GUI interface
	...
	public void buttonClicked(JButton buttonObj){
		if(buttonObj == Frequency){//finds frequency in string
			try{
				...
				outputArea.setText(adminObj.getFrequency(stringField1.getText().toLowerCase(), new arraySet(stringField1.getText().toLowerCase())));
			...
			try{
				...
				outputArea.setText(adminObj.valuesInCommon(new arraySet(stringField1.getText().toLowerCase()), new arraySet(stringField2.getText().toLowerCase())));
				stringField1.setText("");
			...
			try{
				...
				outputArea.setText(adminObj.combinedSet(new arraySet(stringField1.getText().toLowerCase()), new arraySet(stringField2.getText().toLowerCase())));
				stringField1.setText("");
				stringField2.setText("");
				stringField1.grabFocus();
			}
			...
			try{
				mainGUI.errorChecking(stringField1.getText().toLowerCase(), stringField2.getText().toLowerCase());
				outputArea.setText(adminObj.determineSubset(new arraySet(stringField1.getText().toLowerCase()), new arraySet(stringField2.getText().toLowerCase())));
				stringField1.setText("");
				stringField2.setText("");
				stringField1.grabFocus();
			}
			...
			try{
				mainGUI.errorChecking(stringField1.getText().toLowerCase(), stringField2.getText().toLowerCase());
				outputArea.setText(adminObj.Remove(new arraySet(stringField1.getText().toLowerCase()), new arraySet(stringField2.getText().toLowerCase())).toString());
				stringField1.setText("");
				stringField2.setText("");
				stringField1.grabFocus();
			}
